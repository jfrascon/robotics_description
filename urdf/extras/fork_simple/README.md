...
The `fork_simple_macro.xacro` macro and its model-specific wrappers
(`fork_simple_0_macro.xacro`, `fork_simple_1_macro.xacro`, ...) assume the frame convention
...
- Place the resulting values (`mass`, `inertial_elements`, `center_of_mass`) in a model-specific macro such as `fork_simple_0_macro.xacro`.
